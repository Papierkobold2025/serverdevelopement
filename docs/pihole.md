...
- *.proxmox.midominio.com para nodos Proxmox

- *.backup.midominio.com para servidores Backup

- *.apps.midominio.com para servicios

- *.monitoring.midominio.com para servicios de monitoreo

- *.network.midominio.com para servicios de red

- *.storage.midominio.com para servicios de almacenamiento
